    ...
    <?php if(Route::has('login')): ?>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-rights')): ?>
                <button style="border: 1px solid darkgrey"><a href="<?php echo e(route('addBook')); ?>">Добавить книгу</a></button>
            <?php endif; ?>
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <?php $__currentLoopData = $allBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('oneBook', $book->id)); ?>"
                        ...
                        <p>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-rights')): ?>
                                <button style="border: 1px solid darkgrey"><a
                                            href="<?php echo e(route('updateBook', $book->id)); ?>">Редактировать</a></button>
                                <button style="border: 1px solid darkgrey"><a
                                            href="<?php echo e(route('deleteBook', $book->id)); ?>">Удалить</a></button>
                            <?php endif; ?>
                        </p>
